...
namespace OdessaMasonFireworks.UI.MVC.Controllers
{
    public class BrandsController : Controller
    {
        ...
        public BrandsController(OdessaMasonFireworksContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Brands != null ? 
                          ...
                          Problem("Entity set 'OdessaMasonFireworksContext.Brands'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'OdessaMasonFireworksContext.Brands'  is null.");
            }
            var brand = await _context.Brands.FindAsync(id);
            if (brand != null)
            {
