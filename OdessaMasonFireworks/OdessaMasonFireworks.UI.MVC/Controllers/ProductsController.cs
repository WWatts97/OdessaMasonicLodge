...
namespace OdessaMasonFireworks.UI.MVC.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public ProductsController(OdessaMasonFireworksContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("ProductId,ProductName,Description,TypeId,BrandId,UnitsInStock,UnitsOrdered,UnitType,UnitsPerBox,BoxesPerCase,CostPerUnit,PricePerUnit,ProductImage")] Product product)
        {
